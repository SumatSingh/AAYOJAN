    ...
    <div className="col main pt-5 mt-3">
        ...
        {/* <div className="row placeholders mb-3">
            <div className="col-6 col-sm-3 placeholder text-center">
                <img src="assets///placehold.it/200/dddddd/fff?text=1" className="mx-auto img-fluid rounded-circle" alt="Generic placeholder thumbnail"/>
                <h4>Responsive</h4>
                <span className="text-muted">Device agnostic</span>
            </div>
            <div className="col-6 col-sm-3 placeholder text-center">
                <img src="assets///placehold.it/200/e4e4e4/fff?text=2" className="mx-auto img-fluid rounded-circle" alt="Generic placeholder thumbnail"/>
                <h4>Frontend</h4>
                <span className="text-muted">UI / UX oriented</span>
            </div>
            <div className="col-6 col-sm-3 placeholder text-center">
                <img src="assets///placehold.it/200/d6d6d6/fff?text=3" className="mx-auto img-fluid rounded-circle" alt="Generic placeholder thumbnail"/>
                <h4>HTML5</h4>
                <span className="text-muted">Standards-based</span>
            </div>
            <div className="col-6 col-sm-3 placeholder text-center">
                <img src="assets///placehold.it/200/e0e0e0/fff?text=4" className="center-block img-fluid rounded-circle" alt="Generic placeholder thumbnail"/>
                <h4>Framework</h4>
        ...
        <div className="card-columns mb-3">
            <div className="card">
                <img className="card-img-top img-fluid" src="assets///placehold.it/600x200/444/fff?text=..." alt="Card image cap"/>
                <div className="card-body">
            ...
            <div className="card">
                <img className="card-img-top img-fluid" src="assets///placehold.it/600x200/bbb/fff?text=..." alt="Card image cap"/>
                <div className="card-body">
            ...
            <div className="card">
                <img className="card-img img-fluid" src="assets///placehold.it/600x200/777/fff?text=..." alt="Card image"/>
            </div>
        ...
        <div className="row mb-3">
            ...
            <div className="col-lg-6">
                ...
                <ul className="nav nav-tabs" role="tablist">
                    <li className="nav-item">
                        <Link to="/" className="nav-link active" href="#home1" role="tab" data-toggle="tab">Home</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/" className="nav-link" href="#profile1" role="tab" data-toggle="tab">Profile</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/" className="nav-link" href="#messages1" role="tab" data-toggle="tab">Messages</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/" className="nav-link" href="#settings1" role="tab" data-toggle="tab">Settings</Link>
                    </li>
                </ul>
            ...
            <div className="col-lg-6">
                <div className="card card-default card-body">
                    <ul id="tabsJustified" className="nav nav-tabs nav-justified">
                        <li className="nav-item">
                            <Link to="/" className="nav-link" href="" data-target="#tab1" data-toggle="tab">List</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/" className="nav-link active" href="" data-target="#tab2" data-toggle="tab">Profile</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/" className="nav-link" href="" data-target="#tab3" data-toggle="tab">More</Link>
                        </li>
                    </ul>
                    ...
                    <div id="tabsJustifiedContent" className="tab-content">
                        <div className="tab-pane" id="tab1">
                            <div className="list-group">
                                <Link to="" className="list-group-item"><span className="float-right label label-success">51</span> Home Link</Link>
                                <Link to="" className="list-group-item"><span className="float-right label label-success">8</span> Link 2</Link>
                                <Link to="" className="list-group-item"><span className="float-right label label-success">23</span> Link 3</Link>
                                <Link to="" className="list-group-item text-muted">Link n..</Link>
                            </div>
                        </div>
                        <div className="tab-pane active" id="tab2">
                            <div className="row">
                                ...
                                <div className="col-sm-5"><img src="assets///placehold.it/170" className="float-right img-responsive img-rounded"/></div>
                            </div>
                            <hr/>
                            <Link to="/" className="btn btn-info btn-block">Read More Profiles</Link>
                            <div className="spacer5"></div>
                        </div>
                        <div className="tab-pane" id="tab3">
                            <div className="list-group">
                                <Link to="" className="list-group-item"><span className="float-right label label-info label-pill">44</span> <code>.panel</code> is now <code>.card</code></Link>
                                <Link to="" className="list-group-item"><span className="float-right label label-info label-pill">8</span> <code>.nav-justified</code> is deprecated</Link>
                                <Link to="" className="list-group-item"><span className="float-right label label-info label-pill">23</span> <code>.badge</code> is now <code>.label-pill</code></Link>
                                <Link to="" className="list-group-item text-muted">Message n..</Link>
                            </div>
                        </div>
                    </div>
            ...
            <div className="col-lg-6">
                ...
                <p className="mt-4">
                    <Link to="/go/KrUO8QpyXP/bootstrao-4-dashboard" target="_ext">Get this Bootstrap 4 admin dashboard at Codeply</Link>
                </p>
            </div>
        </div>
