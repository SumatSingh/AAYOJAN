...
export default function EtainmentForm() {
  return (
     <Fragment>
                  ...
                  <div className="col-md-6 col-lg-7 d-flex align-items-center">
                    <div className="card-body p-4 p-lg-5 text-black">
                      ...
                      <form>
                        ...
                        <div className="form-outline mb-1 col-md-6 row-1">
                        <label className="form-label" htmlfor="form2Example17">System Required from</label>
                            <input type="date" id="form2Example17" className="form-control form-control-lg" />
                            
                        </div>

                        <div className="form-outline mb-1 col-md-6 row-1">
                        <label className="form-label" htmlfor="form2Example17">To</label>
                            <input type="date" id="form2Example17" className="form-control form-control-lg" />
                        ...
                        <div className="form-outline mb-1 col-md-6 row-1">
                        <label className="form-label" htmlfor="form2Example17">no. of total days</label>
                          <input type="number" id="form2Example17" className="form-control form-control-lg" placeholder='0'/>
                          
                        </div>
      
                        <div className="form-outline mb-1">
                        <label className="form-label" htmlfor="form2Example27">price Rs./-</label>
                          <input type="price" id="form2Example27" className="form-control form-control-lg" placeholder='Rs./-' disabled/>
                         
                        </div>

      
                        <div className="pt-1 mb-1">
                          <button className="btn btn-dark btn-lg btn-block mt-2" type="button">submit & go for payment</button>
                        </div>
