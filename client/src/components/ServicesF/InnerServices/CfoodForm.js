...
export default function CfoodForm() {
  return (
     <Fragment>
                  ...
                  <div className="col-md-6 col-lg-7 d-flex align-items-center">
                    <div className="card-body p-4 p-lg-5 text-black">
                      ...
                      <form>
                        ...
                        <h5 className="fw-normal mb-1 pb-3" style={{letterSpacing: "1px"}}>Fill the Details Below</h5>
                        ...
                        <div className="form-outline mb-1">
                        <label className="form-label" htmlfor="form2Example17">Venue</label>
                            <input type="text" id="form2Example17" className="form-control form-control-lg" />
                        ...
                        <div className="form-outline mb-1">
                        <label className="form-label" htmlfor="form2Example17">No. of Guests</label>
